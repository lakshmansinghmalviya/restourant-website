        ...
        <div className="w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-4xl mx-auto px-4">
            ...
            <div className="pt-4 text-center md:text-left">
              <button
                type="submit"
                className="bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-8 rounded-sm transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-900 uppercase tracking-wide text-sm w-full md:w-auto"
              >
                RESERVATION NOW
              </button>
            </div>
